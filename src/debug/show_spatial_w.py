...
def main():
    ...
    paths = {
        ...
        'all_pc1': os.path.join(data_root, 'pc1/all/'),
    }
    for k in paths:
    ...
    # image_name = 'keble_000126'  # Three people
    image_name = 'radcliffe_camera_000289'  # Round building
    # image_name = 'magdalen_000477'  # Long building
