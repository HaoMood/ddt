...
class VGGManager(object):
    ...
    def getPool5(self, image_path, pool5_path):
        ...
        for i, name_i in enumerate(name_list):
            ...
            np.save(os.path.join(self._paths[pool5_path], name_wo_ext_i),
                    pool5_i)
...
def main():
    ...
    paths = {
        ...
        'crop_pool5': os.path.join(image_root, 'pool5/crop/'),
        'full_pool5': os.path.join(image_root, 'pool5/full/'),
    ...
    manager.getPool5('all_image', 'all_pool5')
    manager.getPool5('crop_image', 'crop_pool5')
    manager.getPool5('full_image', 'full_pool5')
